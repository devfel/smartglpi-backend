...
# # TODO: MUDAR NOME PARA get_glpi_tickets
# from src.glpi_api_controller import search_tickets
...
#     search_tickets(individual_ticket_ids=[12492, 12084, 12789, 11655, 12320])
...
#     # search_tickets(individual_ticket_ids=[12492, 12084, 12789, 11655, 12320, 12390, 12509, 12358, 12342, 12864])
